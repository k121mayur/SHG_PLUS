...
new_shg = SHG(
            ...
            formation_date= datetime.strptime("2022-01-01", "%Y-%m-%d").date(),
            first_saving_date= datetime.strptime("2022-01-01", "%Y-%m-%d").date(),
...
new_shg_1 = SHG(
            ...
            formation_date= datetime.strptime("2022-03-01", "%Y-%m-%d").date(),
            first_saving_date= datetime.strptime("2022-01-01", "%Y-%m-%d").date(),
